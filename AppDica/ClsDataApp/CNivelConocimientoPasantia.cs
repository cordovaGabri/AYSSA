...
{
    public class CNivelConocimientoPasantia : CSqlvars
    {
        public CNivelConocimientoPasantia(string ConexionData)
        {
            _ConexionData = ConexionData;
        }

        public ClsDataSets.DS_TB_EMP Detalle(int Id, int IdNivel, int IdPasantia, int IdHabilidad,
            string UsuaCrea, DateTime FechCrea, string UsuaActu, DateTime FechActu, int OpcionConsulta)
        {
            ...
            try
            {
                ...
                ObjAdapter = new SqlDataAdapter("SP_TB_NIVEL_CONOCIMIENTO_PASANTIA_GetByAll", ObjConnection);
                ...
                ObjAdapter.SelectCommand.Parameters.AddWithValue("@ID_HABILIDAD", IdHabilidad);
                ...
                ObjAdapter.Fill(objDataSet, "TB_NIVEL_CONOCIMIENTO_PASANTIA");
        ...
        public DataQuery Actualizacion(int Id, int IdNivel, int IdPasantia, int IdHabilidad,
            ...
            try
            {
                ...
                switch (OpcionActualizacion)
                {
                    case TipoActualizacion.Adicionar:
                        StrCommand = "SP_TB_NIVEL_CONOCIMIENTO_PASANTIA_INSERT";
                        break;
                ...
                ObjCommand.Parameters.AddWithValue("@ID_HABILIDAD", IdHabilidad);
