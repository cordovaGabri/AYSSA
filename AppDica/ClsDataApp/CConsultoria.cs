...
namespace ClsDataApp
{
    public class CConsultoria :CSqlvars
    {
        ...
        public ClsDataSets.DS_TB_EMP Detalle(int Id, string NumContrato, string NombreProyecto, DateTime FechContrato,
        ...
        public DataQuery Actualizacion(int Id, string NumContrato, string NombreProyecto, DateTime FechContrato,
