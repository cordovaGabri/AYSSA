...
namespace ClsDataApp
{
    public class CDocumento : CSqlvars
    {
        ...
        public DS_TBC Detalle(int Id, string Documento, string Descripcion, char Estado,
        ...
        public DataQuery Actualizacion(string Id, string Documento, string Descripcion, char Estado,
